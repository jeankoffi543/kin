...
class DeviceGpsLocation extends Model
{
    use HasFilters, IsSearchable, IsSortable;

    protected $table = 'device_gps_locations';
    ...
    public function filters(): array
    {
        return [
            ...
            Filter::make('recorded_at', 'recorded_at__between')
                ...
                ->setValidationRules(['recorded_at__between' => 'nullable']),
        ];
    }
