...
class DeviceSocialMessage extends Model
{
    use HasFilters, IsSearchable, IsSortable;

    protected $table = 'device_social_messages';
    ...
    {
        return [
            Search::make('sender_name', SearchOperator::LIKE),
            Search::make('message', SearchOperator::LIKE),
    ...
    public function filters(): array
    {
        return [
            ...
            Filter::make('platform', 'platform__eq')
                ->setOperator(FilterOperator::EQUAL)
                ->setValidationRules(['platform__eq' => ['string', new \Illuminate\Validation\Rules\Enum(SocialPlatform::class)]]),
